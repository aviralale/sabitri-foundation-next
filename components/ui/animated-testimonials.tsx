          ...
          <div className="flex flex-col gap-4 pt-8 sm:pt-10 md:pt-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-3">
                ...
                >
                  <ArrowLeft className="h-5 w-5 text-gray-600 dark:text-gray-300 transition-transform duration-300 group-hover/button:translate-x-[-2px] group-hover/button:text-indigo-600 dark:group-hover/button:text-indigo-400" />
                </button>
                <button
                  onClick={handleNext}
                  className="group/button flex h-10 w-10 items-center justify-center rounded-full bg-white/90 border border-gray-200 hover:border-indigo-400 hover:bg-indigo-50 dark:bg-gray-800 dark:border-gray-700 dark:hover:border-indigo-500 dark:hover:bg-indigo-950/50 transition-all duration-300 shadow-sm"
                ...
                >
                  <ArrowRight className="h-5 w-5 text-gray-600 dark:text-gray-300 transition-transform duration-300 group-hover/button:translate-x-[2px] group-hover/button:text-indigo-600 dark:group-hover/button:text-indigo-400" />
                </button>
              </div>
